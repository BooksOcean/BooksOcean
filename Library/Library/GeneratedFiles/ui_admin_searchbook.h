/********************************************************************************
** Form generated from reading UI file 'admin_searchbook.ui'
**
...
#ifndef UI_ADMIN_SEARCHBOOK_H
#define UI_ADMIN_SEARCHBOOK_H
...
public:
    ...
    void setupUi(QWidget *admin_searchbook)
    {
        if (admin_searchbook->objectName().isEmpty())
            admin_searchbook->setObjectName(QStringLiteral("admin_searchbook"));
        admin_searchbook->resize(1117, 771);
        horizontalLayout = new QHBoxLayout(admin_searchbook);
        horizontalLayout->setSpacing(6);
        horizontalLayout->setContentsMargins(11, 11, 11, 11);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        frame = new QFrame(admin_searchbook);
...
"cursor:pointer;"));
        ...
        frame_3 = new QFrame(admin_searchbook);
...
"font-size:18px;"));
        ...
        tableWidget->setStyleSheet(QStringLiteral("text-align:center;"));
...
"font-size:18px;"));
        ...
        retranslateUi(admin_searchbook);

        QMetaObject::connectSlotsByName(admin_searchbook);
    } // setupUi

    void retranslateUi(QWidget *admin_searchbook)
    {
        admin_searchbook->setWindowTitle(QApplication::translate("admin_searchbook", "admin_searchbook", Q_NULLPTR));
        btnPersonal->setText(QApplication::translate("admin_searchbook", "\344\270\252\344\272\272\344\270\255\345\277\203", Q_NULLPTR));
        btnSearchuser->setText(QApplication::translate("admin_searchbook", "\350\264\246\345\217\267\347\256\241\347\220\206", Q_NULLPTR));
        btnSearchbook->setText(QApplication::translate("admin_searchbook", "\345\233\276\344\271\246\347\256\241\347\220\206", Q_NULLPTR));
        btnClassify->setText(QApplication::translate("admin_searchbook", "\345\210\206\347\261\273\347\256\241\347\220\206", Q_NULLPTR));
        btnLogout->setText(QApplication::translate("admin_searchbook", "\351\200\200\345\207\272\347\231\273\345\275\225", Q_NULLPTR));
        btnSearch->setText(QString());
        btnAdd->setText(QApplication::translate("admin_searchbook", "\346\267\273\345\212\240\345\233\276\344\271\246", Q_NULLPTR));
        radioName->setText(QApplication::translate("admin_searchbook", "\344\271\246\345\220\215", Q_NULLPTR));
        radioAuthor->setText(QApplication::translate("admin_searchbook", "\344\275\234\350\200\205", Q_NULLPTR));
        radioISBN->setText(QApplication::translate("admin_searchbook", "ISBN", Q_NULLPTR));
        radioClassify->setText(QApplication::translate("admin_searchbook", "\345\210\206\347\261\273", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("admin_searchbook", "\344\271\246\345\220\215", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("admin_searchbook", "\344\275\234\350\200\205", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("admin_searchbook", "\345\207\272\347\211\210\347\244\276", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("admin_searchbook", "\345\272\223\345\255\230\351\207\217", Q_NULLPTR));
        ...
        ___qtablewidgetitem5->setText(QApplication::translate("admin_searchbook", "\345\242\236\345\212\240\345\272\223\345\255\230", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidget->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("admin_searchbook", "\346\233\264\346\224\271\345\233\276\344\271\246", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem7 = tableWidget->horizontalHeaderItem(7);
        ___qtablewidgetitem7->setText(QApplication::translate("admin_searchbook", "\345\210\240\351\231\244\345\233\276\344\271\246", Q_NULLPTR));
        ...
        etIndexPage->setText(QApplication::translate("admin_searchbook", "0", Q_NULLPTR));
        lineEdit_2->setText(QApplication::translate("admin_searchbook", "\351\241\265\357\274\214\345\205\261", Q_NULLPTR));
        etCountPage->setText(QApplication::translate("admin_searchbook", "0", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("admin_searchbook", "\351\241\265", Q_NULLPTR));
        btnNextPage->setText(QApplication::translate("admin_searchbook", "\344\270\213\344\270\200\351\241\265", Q_NULLPTR));
        btnTheLast->setText(QApplication::translate("admin_searchbook", "\345\260\276\351\241\265", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class admin_searchbook: public Ui_admin_searchbook {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMIN_SEARCHBOOK_H
