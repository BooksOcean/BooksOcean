/********************************************************************************
** Form generated from reading UI file 'admin_classify.ui'
**
...
#ifndef UI_ADMIN_CLASSIFY_H
#define UI_ADMIN_CLASSIFY_H
...
public:
    ...
    void setupUi(QWidget *admin_classify)
    {
        ...
        frame = new QFrame(admin_classify);
...
""));
        ...
        frame_3 = new QFrame(admin_classify);
...
"font-size:18px;"));
        ...
        retranslateUi(admin_classify);

        QMetaObject::connectSlotsByName(admin_classify);
    } // setupUi

    void retranslateUi(QWidget *admin_classify)
    {
        ...
        ___qtablewidgetitem1->setText(QApplication::translate("admin_classify", "\345\210\240\351\231\244\345\210\206\347\261\273", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("admin_classify", "\344\277\256\346\224\271\345\210\206\347\261\273", Q_NULLPTR));
        btnFirstPage->setText(QApplication::translate("admin_classify", "\351\246\226\351\241\265", Q_NULLPTR));
        btnLastPage->setText(QApplication::translate("admin_classify", "\344\270\212\344\270\200\351\241\265", Q_NULLPTR));
        lineEdit_4->setText(QApplication::translate("admin_classify", "\345\275\223\345\211\215\347\254\254", Q_NULLPTR));
        etIndexPage->setText(QApplication::translate("admin_classify", "0", Q_NULLPTR));
        lineEdit_2->setText(QApplication::translate("admin_classify", "\351\241\265\357\274\214\345\205\261", Q_NULLPTR));
        etCountPage->setText(QApplication::translate("admin_classify", "0", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("admin_classify", "\351\241\265", Q_NULLPTR));
        btnNextPage->setText(QApplication::translate("admin_classify", "\344\270\213\344\270\200\351\241\265", Q_NULLPTR));
        btnTheLast->setText(QApplication::translate("admin_classify", "\345\260\276\351\241\265", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class admin_classify: public Ui_admin_classify {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMIN_CLASSIFY_H
