/********************************************************************************
** Form generated from reading UI file 'admin_updatepassword.ui'
**
...
#ifndef UI_ADMIN_UPDATEPASSWORD_H
#define UI_ADMIN_UPDATEPASSWORD_H
...
public:
    ...
    {
        if (admin_updatepassword->objectName().isEmpty())
            admin_updatepassword->setObjectName(QStringLiteral("admin_updatepassword"));
        admin_updatepassword->resize(974, 731);
        horizontalLayout = new QHBoxLayout(admin_updatepassword);
        horizontalLayout->setSpacing(6);
        horizontalLayout->setContentsMargins(11, 11, 11, 11);
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        frame = new QFrame(admin_updatepassword);
...
"cursor:pointer;"));
        ...
        frame_3 = new QFrame(admin_updatepassword);
...
"font-family:\"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        lineEdit->setGeometry(QRect(50, 70, 81, 31));
...
"text-align:left;"));
        ...
        lineEdit_13->setGeometry(QRect(50, 130, 81, 31));
...
"text-align:left;"));
        ...
        lineEdit_14->setGeometry(QRect(50, 190, 101, 31));
...
"padding-bottom:5;"));
        ...
        retranslateUi(admin_updatepassword);

        QMetaObject::connectSlotsByName(admin_updatepassword);
    } // setupUi

    void retranslateUi(QWidget *admin_updatepassword)
    {
...
namespace Ui {
    class admin_updatepassword: public Ui_admin_updatepassword {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMIN_UPDATEPASSWORD_H
